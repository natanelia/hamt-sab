...
describe('Vector', () => {
  beforeEach(() => resetVector());

  test('empty vector has size 0', () => {
    expect(new Vector('number').size).toBe(0);
  });

  test('push increases size', () => {
    const v = new Vector('number').push(1).push(2);
    expect(v.size).toBe(2);
  });

  test('get returns correct index', () => {
    const v = new Vector('number').push(10).push(20).push(30);
  ...
  test('get out of bounds returns undefined', () => {
    const v = new Vector('number').push(1);
    expect(v.get(-1)).toBeUndefined();
    expect(v.get(1)).toBeUndefined();
  });

  test('set updates value', () => {
    const v = new Vector('number').push(1).push(2).set(1, 99);
    expect(v.get(0)).toBe(1);
    expect(v.get(1)).toBe(99);
  });

  test('set out of bounds returns same vector', () => {
    const v1 = new Vector('number').push(1);
    const v2 = v1.set(5, 99);
    expect(v1).toBe(v2);
  });

  test('pop removes last', () => {
    const v = new Vector('number').push(1).push(2).push(3).pop();
    expect(v.size).toBe(2);
  ...
  test('values iteration', () => {
    const v = new Vector('number').push(1).push(2).push(3);
    expect([...v.values()]).toEqual([1, 2, 3]);
  });

  test('forEach with index', () => {
    const v = new Vector('number').push(10).push(20);
  ...
  test('pushMany', () => {
    const v = new Vector('number').pushMany([1, 2, 3]);
    expect(v.toArray()).toEqual([1, 2, 3]);
  });
  ...
  test('string type', () => {
    const v = new Vector('string').push('a').push('b').push('c');
  ...
  test('string set', () => {
    const v = new Vector('string').push('a').push('b').set(1, 'x');
    expect(v.toArray()).toEqual(['a', 'x']);
  });

  test('boolean type', () => {
    const v = new Vector('boolean').push(true).push(false).push(true);
  ...
  test('object type', () => {
    const o1 = { x: 1 };
    const o2 = { y: 2 };
    const v = new Vector('object').push(o1).push(o2);
    expect(v.get(0)).toEqual(o1);
    expect(v.get(1)).toEqual(o2);
  });

  test('string interning', () => {
    const v = new Vector('string').push('hello').push('world').push('hello');
